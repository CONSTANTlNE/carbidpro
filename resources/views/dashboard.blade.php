                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox1">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <span style="color: darkorange;font-size: 30px">{{$totalCustomers}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox4">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <span style="color: #009688;font-size: 30px">{{$totalCars}}</span>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox3">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <span style="color: #FF8C00;font-size: 30px">{{$totalCarsPaid}}</span>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox2">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <span  style="color:#FE0000;font-size: 30px">{{$totalCarsDue}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox1">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <span style="color: darkorange;font-size: 30px">{{ round($totalInterest)}}</span>
                            </div>
                        </div>
                    </div>
