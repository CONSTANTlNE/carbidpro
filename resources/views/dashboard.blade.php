                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox1">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5>Total Customers : <span >{{$totalCustomers}}</span></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox1">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5>Total Shipping : <span >{{$totalShipping}}</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox1">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5>Total Interest : <span> {{ round($totalInterest)}}</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox4">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5> Total Deposits Received : <span >{{$totalDeposits}}</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox4">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5> Total Spent on cars : <span >{{$totalSpent}}</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox4">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5> Total Amount Due : <span>{{ $totalAmountDue}}</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox3">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5>Total Cars (Paid) : <span>{{$totalCarsPaid}}</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4">
                        <div style="background: black!important;" id="cardbox2">
                            <div style="background: black!important;" class="statistic-box">
                                ...
                                <h5> Total Cars (Due) : <span>{{$totalCarsDue}}</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
