                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                    @foreach($draftsSystem as $index=> $draft)
                        ...
                        <div class="card lobicard" id="lobicard-custom-controls" data-sortable="true">
                            ...
                            <div class="card-body">
                                <div class="btn-group">
                                    {{-- Auction Create Modal--}}
                                    <button type="button" class="btn green_btn custom_grreen2 mb-3" data-toggle="modal"
                                            data-target="#generaldraft">
                                        Add New General Draft
                                    </button>
                                    <div class="modal fade" id="generaldraft" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">New General Draft</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                        @foreach($draftsGeneral as $index2=> $draft2)
                                            <tr class="text-center">
                                                <td>{{$draft2->action_description}}</td>
                                                <td>{{$draft2->draft}}</td>
                                                <td>
                                                    <form action="{{route('sms.drafts.activate')}}" method="post"
                                                          novalidate>
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$draft2->id}}">
                                                        @if($draft2->is_active==1)
                                                            <button type="submit"
                                                                    class="btn btn-success btn-rounded w-md m-b-5">Active
                                                            </button>
                                                        @else
                                                ...
                                                <td>
                                                    {{--Edit Modal--}}
                                                    <button type="button" class="btn btn-add btn-sm" data-toggle="modal"
                                                            data-target="#updategeneral{{$index2}}"><i class="fa fa-pencil"></i>
                                                    </button>
                                                    <div class="modal fade" id="updategeneral{{$index2}}" tabindex="-1"
                                                         role="dialog" style="display: none;" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-header-primary">
                                                                                ...
                                                                                <div class="row flex justify-content-center">
                                                                                    ...
                                                                                    <div class="col-md-12 form-group">
                                                                                        <input type="text"
                                                                                               ...
                                                                                               required
                                                                                               placeholder="Draft Description"
                                                                                               class="form-control" value="{{$draft2->action_description}}">
                                                                                    </div>
                                                                                    <div class="col-md-12 form-group">
                                                                                    <textarea style="font-size: 20px"
                                                                                              required name="draft"
                                                                                              class="form-control"
                                                                                              rows="10">{{$draft2->draft}}</textarea>
                                                                                    </div>
                                                                                    <div class="col-md-12 form-group user-form-group mt-3">
                                                                                        <div class="flex justify-content-center">
                                                                                            <button type="button"
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#deletegeneral{{$index2}}"><i
                                                                class="fa fa-trash-o"></i>
                                                    </button>
                                                    <div class="modal fade" id="deletegeneral{{$index2}}" tabindex="-1"
                                                         role="dialog" style="display: none;" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-header-primary">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                <fieldset>
                                                                                    <div class="col-md-12 form-group user-form-group">
                                                                                        <label class="control-label">Delete
                                                                                            Draft : {{$draft2->action_description}}
                                                                                            ?</label>
                                                                                        <div class="flex justify-content-center mt-3">
                                                                                            <button type="button"
                                                                                                    data-dismiss="modal"
