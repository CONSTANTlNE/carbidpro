                                    ...
                                    @foreach($customers as $index=> $customer)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                {{--titles Modal--}}
                                                <button
                                                        hx-get="{{route('customer.titles.htmx')}}"
                                                        hx-target="#titlesTarget"
                                                        hx-vals='{"id": "{{$customer->id}}"}'
                                                        type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                                        data-target="#customerTitles">TITLES
                                                </button>
                                            </td>
                                            @if(request()->query('archive'))
...
{{--     customer titles modal via htmx--}}
    <div class="modal fade" id="customerTitles" tabindex="-1"
         role="dialog" style="display: none;" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <h3><i class="fa fa-user m-r-5"></i> Customer Titles
                    </h3>
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">×
                    </button>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12" id="titlesTarget">
