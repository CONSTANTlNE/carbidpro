                                                ...
                                                <tr class="info">
                                                    ...
                                                    <td style="min-width: 90px!important;">
                                                        ...
                                                        <select class="form-control" name="trt_payed" id="trt_payed">
                                                            ...
                                                            <option value="no"
                                                                    {{ $cargroup->trt_payed == 'no' ? 'selected' : '' }}>
                                                                NO
                                                            </option>
                                                        </select>
                                                        ...
                                                        <select class="form-control" name="thc_payed" id="thc_payed">
                                                            ...
                                                            <option value="no"
                                                                    {{ $cargroup->thc_payed == 'no' ? 'selected' : '' }}>
                                                                NO
                                                            </option>
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control" name="remark" id="remark"
                                                                  cols="30"
                                                                  rows="2">{{ $cargroup->remark ?? '' }}</textarea>
                                                    </td>
                                                    <td>
