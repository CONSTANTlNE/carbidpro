                                                        ...
                                                        <form class="form-horizontal"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 form-group text-center">
                                                                    ...
                                                                    <input id="customerName" name="full_name"
                                                                           type="text"
                                                                ...
                                                                <div class="col-md-4 form-group text-center">
                                                                    <label class="text-center">Car Vin</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn-edit-record btn btn-add btn-sm"
                                                            ...
                                                            data-target="#edit{{$index}}"><i class="fa fa-pencil"></i></button>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <form class="form-horizontal"
                                                                                  ...
                                                                                  method="post">
                                                                                @csrf
                                                                                <input type="hidden" name="payment_id" value="{{$payment_report->id}}">

                                                                                <div class="row">
                                                                                    <div class="col-md-4 form-group text-center">

                                                                                        <input value="{{$payment_report->customer_id}}" type="hidden"  name="customer_id" id="customerID{{$index}}">
                                                                                        <label class="text-center">Customer</label>
                                                                                        <input id="customerName{{$index}}" name="full_name" value="{{$payment_report->customer->contact_name}}"
                                                                                               type="text"
                                                                                    ...
                                                                                    <div class="col-md-4 form-group text-center">
                                                                                        ...
                                                                                        <input value="{{$payment_report->car_id}}" type="hidden" name="car_id" id="carID{{$index}}">
                                                                                        <label class="text-center">Make / Model</label>
                                                                                        <input type="text" id="carName{{$index}}" value="{{$payment_report->car->make_model_year}}"
                                                                                               onfocus="
                                                                                    ...
                                                                                    <div class="col-md-4 form-group text-center">
                                                                                        <label class="text-center">Car Vin</label>
                                                                                        <input type="text" id="carVIN{{$index}}" value="{{$payment_report->car->vin}}">
                                                                                ...
                                                                                <div class="row justify-content-center">
                                                                                    <div class="col-md-6 form-group text-center">
                                                                                        <label class="text-center">Amount</label>
                                                                                        <input value="{{($payment_report->amount)*-1}}" name="amount" type="text">

                                                                                        <input type="checkbox" name="approve" @checked($payment_report->is_approved)>
                                                    ...
                                                    {{-- Search Customer Modal--}}
                                                    <a id="searchmodalbtn{{$index}}" data-toggle="modal" data-target="#searchCustomer{{$index}}"></a>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <fieldset>
                                                                                <div class="col-md-12 form-group user-form-group">
                                                                                    <input type="hidden" id="customer_id{{$index}}"
                                                                                           name="customer_id">
                                                                                    <div class="d-flex justify-content-center">
                                                                                        <input hx-get="{{route('customer.search.htmx')}}"
                                                                                    ...
                                                                                    <div id="searchtarget{{$index}}" class="text-center mt-3"></div>

                                                                                    <div>
                                                                                        <div class="d-flex justify-content-center mt-3">
                                                                                            <button id="closeSearch{{$index}}" type="button"
                                                                                                    data-dismiss="modal"
                                                                                                    class="btn btn-danger btn-sm mr-2">
                                                                                                Close Search
                                                                                            </button>
                                                    ...
                                                    {{-- Search Customer Cars Modal--}}
                                                    <a id="searchCarBtn{{$index}}" data-toggle="modal" data-target="#searchCarModal{{$index}}"></a>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <fieldset>
                                                                                <div class="col-md-12 form-group user-form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="d-flex justify-content-center mt-3">
                                                                                            <button id="closeSearch2{{$index}}" type="button"
                                                                                                    data-dismiss="modal"
                                                                                                    class="btn btn-danger btn-sm mr-2">
                                                                                                Close Search
                                                                                            </button>
                                                    ...
                                                    <!-- DELETE Record Modal -->
                                                    <div class="modal fade" id="deleteModal{{$index}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <form action="{{ route('carpayment.delete')}}" method="POST" >
                                                                @csrf
                                                                <input type="hidden" name="id" value="{{ $payment_report->id}}">
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-header-primary">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <p>Car: {{ $payment_report->car->make_model_year}}</p>
                                                                    <p>Dealer: {{ $payment_report->customer->contact_name}}</p>
