    ...
    <section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" style="padding: 70px 0px 70px"
        ...
        <div class="container">
            <div class="ft-breadcrumb-content headline text-center position-relative">
                <h2 style="margin-top: 50px;">{!! $tr->translate('Calculator') !!}</h2>
        ...
        <div class="row">
                    ...
                    @foreach ($loadtypes as $key => $loadtype)
                        <div class='load-type'>
                            ...
                            <label for="{{ $key }}">
                                ...
                                <span>{!! $tr->translate($loadtype['name']) !!}</span>
                            </label>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="col">
                <div class="auction_select">
                    <select class="form-select mb-2" id="AuctionSelect">
                        <option value="-1">{!! $tr->translate('Select Auction') !!}</option>
                    ...
                    <select class="form-select mb-2" id="AucLocationsSelect">
                        <option value="-1" selected="">{!! $tr->translate('Select Location') !!}</option>
                    </select>

                    <select class="form-select mb-2" id="AucPortSelect">
                        <option value="-1" selected="">{!! $tr->translate('Select Exit Port') !!}</option>
                    </select>

                    <select class="form-select mb-2" id="AucCountrySelect">
                        <option value="-1" selected="">{!! $tr->translate('Select Country') !!}</option>
                    ...
                    <select class="form-select mb-2" id="AucPortCitySelect">
                        <option value="-1" selected="">{!! $tr->translate('Select Port/City') !!}</option>
                    </select>

                    <button class="btn btn-success" id="calculate">{!! $tr->translate('Calculate') !!}</button>
            ...
            <div class="col">
                <div class="pricing ground_rate mt-3" style="display: none">
                    <strong>{!! $tr->translate('GROUND RATE') !!}:</strong>
                ...
                <div class="pricing total">
                    <strong>{!! $tr->translate('TOTAL') !!}:</strong>
                    <span id="total"></span>
