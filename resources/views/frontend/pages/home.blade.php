...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="#000"
                ...
                d="M4.5 9h15c.957 1.014 2.5 2.425 2.5 4v3.47c0 .57-.38 1.05-.883 1.117L18 18H6l-3.117-.413C2.38 17.522 2 17.042 2 16.47V13c0-1.575 1.543-2.986 2.5-4"/></g></svg>                            </span>
                ...
                <form action="{{ route('guest.track.container') }}" method="GET">
                    ...
                    <div class="booking-form-input-wrapper d-flex flex-wrap justify-content-center">
                        <label class="booking-form-input position-relative">
                            <span class="booking-form-icon">
{{--                                <i class="flaticon-face-detection"></i>--}}
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#000"
