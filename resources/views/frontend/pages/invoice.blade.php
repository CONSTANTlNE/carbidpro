                ...
                <div style="padding: 0!important" class="cs-invoice cs-style1 cs-no_border  cs-bg-none">
                    <div>
                        <div class="cs-invoice_in" id="download_section">
                            ...
                            <div id="mobilebanks" class="display-flex space-between cs-mb10">
                            ...
                            {{--                                        <div>--}}
                            {{--                                            --}}{{--                        <b class="cs-primary_color">William Stark</b>--}}
                            {{--                                            --}}{{--                        <p>Project Manager</p>--}}
                            ...
                            <div class="display-flex space-between cs-mb5" style="position: relative">
                                ...
                                <img id="image" style="height: 100px;position: absolute;bottom:-35px;right: 0"
                                     src="{{asset('invoiceAssets/assets/img/signature.jpg')}}" alt="...">
                            </div>
                            {{--Signature--}}
