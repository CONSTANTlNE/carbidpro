            ...
            <tr>
                <td class="border-0 pl-0" width="70%">
                    <!-- <h4 class="text-uppercase">
                        <strong><span style="color: #2e75b5;">CARBID</span><span
                                style="color:#c00000">PRO</span></strong>
                    </h4> -->
                    <h3 class="text-uppercase">
                        Invoice NO  <strong>{{ time() }}</strong>
                        <!-- {{ __('invoices::invoice.serial') }} <strong>{{ $invoice->getSerialNumber() }}</strong> -->
                    </h3>
                </td>
        ...
        <tbody>
            <tr>
                <td class="px-0">
                    ...
                    <p class="seller-name">
                        Beneficiary’s Bank: <strong>JSC TBC Bank</strong><br>
                        SWIFT: <strong>TBCBGE22</strong><br>
                        IBAN Account: <strong>GE05TB7081136120100010</strong><br>
                        Beneficiary: <strong>CarBidPro LLC . #405698963</strong><br>
                        Email: <strong>info@carbidpro.com</strong><br>
                        Web: <strong>www.carbidpro.com</strong>
                    </p>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="border-0" width="3%"></th>
                <div style="display:flex;jusify-content:flex-end">
                    <img src="{{ asset('assets/images/image1.png') }}"  alt="signature" height="70">
                </div>
            </tr>
        </thead>
